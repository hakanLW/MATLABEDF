...
% Versions
ResponseInfo.Version.Major = int32( 8 );
ResponseInfo.Version.Minor = int32( 34 );
...
[ QRSComplexes, NoiseRuns, AsystoleRuns, PauseRuns, AnalysisParametersRequest ] = ClassUnusualSignalDetection.GetNoiseRun( ...
    QRSComplexes, ...
    AsystoleRuns, ...
